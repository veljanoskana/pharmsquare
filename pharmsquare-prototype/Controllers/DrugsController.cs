...
namespace pharmsquare_prototype.Controllers
{
    ...
    {
        private DrugContext db = new DrugContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Price,ImageURL")] Drug drug)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Price,ImageURL")] Drug drug)
        {
            if (ModelState.IsValid)
            {
